                            ...
                            <div class="p-6">
                                <div class="flex justify-between">
                                    <div class="grow overflow-hidden">
                                        ...
                                        <h3 class="text-2xl my-6">$907,254</h3>
                                        <p class="text-gray-400 truncate">
                                            <span class="bg-danger rounded-md text-xs px-1.5 py-0.5 text-white me-1"><i
                                                    class="ri-arrow-down-line"></i> 12.60%</span>
                                            <span>Since last month</span>
                                        </p>
                                    </div>
                            ...
                            <div class="p-6">
                                <div class="flex justify-between">
                                    <div class="grow overflow-hidden">
                                        ...
                                        <h3 class="text-2xl my-6">+ 200.6%</h3>
                                        <p class="text-gray-400 truncate">
                                            <span
                                                class="bg-success rounded-md text-xs px-1.5 py-0.5 text-white me-1"><i
                                                    class="ri-arrow-up-line"></i> 9.87%</span>
                                            <span>Since last month</span>
                                        </p>
                                    </div>
                            ...
                            <div class="p-6">
                                <div class="flex justify-between">
                                    <div class="grow overflow-hidden">
                                        ...
                                        <h3 class="text-2xl my-6">91.62%</h3>
                                        <p class="text-gray-400 truncate">
                                            <span
                                                class="bg-success rounded-md text-xs px-1.5 py-0.5 text-white me-1"><i
                                                    class="ri-arrow-up-line"></i> 7.07%</span>
                                            <span>Since last month</span>
                                        </p>
                                    </div>
