...
<head>
    ...
    <title>Forgot Password | EventFlow</title>
    ...
    <div class="flex flex-col md:flex-row w-full max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="md:w-1/2 relative hidden md:block">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-center text-white p-10">
                ...
                <p class="text-xl text-center">Your premier platform for discovering and booking events. Create an account to get started.</p>
        ...
        <div class="md:w-1/2 p-8 md:p-12">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 mt-2">Enter your email so we can send a password reset OTP</p>
            </div>

            <form class="space-y-6" action="{{ route('email.submit') }}" method="POST"> 
                {{-- when you submit form create-user is triggered to submit the form --}}
                @csrf
                ...
                <div>
                     <a href="{{ route('login') }}" class=" text-[0.8rem] underline ">Back to Login</a>
                </div>
            </form>
